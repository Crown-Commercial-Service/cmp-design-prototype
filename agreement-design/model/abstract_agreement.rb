...
domain :Agreements do
  ...
  datatype(:ItemParameter,
    ...
    attribute :detail, Agreements::VariableParameter, ZERO_TO_MANY,
              "define the fixed variables for the item on the agreement"
    attribute :option, Agreements::VariableParameter, ZERO_TO_MANY,
  ...
  datatype(:Agreement,
    ...
    attribute :item, Agreements::ItemParameter, ZERO_TO_MANY,
  ...
  datatype(:Framework, extends: Agreements::Agreement,
           description: "A kind of Framework used for calloffs, composed of Lots") {
    attribute :fwk_number, String, "Such as the RM number"
  }

  datatype(:Lot, extends: Agreements::Agreement) {
    attribute :fwk_id, String, "Part of framework with this id (not fwk_no)", links: Agreements::Framework
  }
  ...
  datatype(:Variable,
    ...
    attribute :param, String, ZERO_TO_MANY, links: Agreements::VariableParameter
  }
  ...
  datatype(:Item,
    ...
    attribute :param, String, links: Agreements::ItemParameter
    attribute :description, String
    attribute :variable, Agreements::Variable, ZERO_TO_MANY
  }

  datatype(:Offer,
           description: "") {
    attribute :id, String, "Offer id, probably a UUID"
    attribute :item_id, String, links: Agreements::Item
    attribute :variant, Agreements::Item, ZERO_TO_MANY
  ...
  datatype(:Catalogue,
    ...
    attribute :id, String
    attribute :item, Agreements::Item, ZERO_TO_MANY
    attribute :agreement_id, String, links: Agreements::Agreement
    attribute :offer, Agreements::Offer, ZERO_TO_MANY
  }

  datatype(:Award,
           description: "") {
    attribute :buyer_id, String, links: Parties::Buyer
    attribute :offer_id, String, ZERO_TO_MANY, links: Agreements::Offer
  }
